...
use crate::infrastructure::sql::{
    ...
    migrations::{
        ...
        m20260324_create_ip_verifications::M20260324CreateIpVerifications,
        m20260630_create_google_verifications::M20260630CreateGoogleVerifications,
    },
};
...
impl<'a> Migrator<'a> {
    ...
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        ...
        vec![
            ...
            Box::new(M20260324CreateIpVerifications),
            Box::new(M20260630CreateGoogleVerifications),
        ]
    }
...
mod tests {
    ...
    #[sqlx::test]
    async fn test_run_successful(pool: PgPool) {
    ...
    #[sqlx::test]
    async fn test_run_failed_rollback(pool: PgPool) {
        struct TestMigration;
        #[async_trait::async_trait]
        impl MigrationTrait for TestMigration {
            fn name(&self) -> &str {
    ...
    #[sqlx::test]
    async fn test_run_migration_twice(pool: PgPool) {
        struct TestMigration;
        #[async_trait::async_trait]
        impl MigrationTrait for TestMigration {
            fn name(&self) -> &str {
