...
pub struct M20260630CreateGoogleVerifications;

#[async_trait]
impl MigrationTrait for M20260630CreateGoogleVerifications {
    async fn up(&self, tx: &mut Transaction<'static, sqlx::Postgres>) -> anyhow::Result<()> {
        let statement = Table::create()
            .table("google_verifications")
            .if_not_exists()
            .col(
                ColumnDef::new("id")
                    .integer()
            ...
            .col(ColumnDef::new("google_identity_hash").text().not_null())
        ...
        let index = Index::create()
            .name("idx_google_verifications_identity_hash_created_at")
            .table("google_verifications")
            .col("google_identity_hash")
            .col("created_at")
            .to_owned();
    ...
    fn name(&self) -> &str {
        "m20260630_create_google_verifications"
    }
}
